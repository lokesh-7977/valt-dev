// Lucide icons (ISC licence), inlined as static SVG markup: 24px grid, 1.5px stroke, currentColor.
// Only these trusted constants are ever parsed as markup; page/model text always goes through textContent.
...
const PATHS = {
  ...
  "image-off":
    '<path d="M2 2l20 20"/><path d="M10.41 10.41a2 2 0 1 1-2.83-2.83"/><path d="M13.5 13.5 6 21"/><path d="M18 12l3 3"/><path d="M3.59 3.59A1.99 1.99 0 0 0 3 5v14a2 2 0 0 0 2 2h14c.55 0 1.052-.22 1.41-.59"/><path d="M21 15V5a2 2 0 0 0-2-2H9"/>',
  ...
  unlink:
    '<path d="m18.84 12.25 1.72-1.71h-.02a5.004 5.004 0 0 0-.12-7.07 5.006 5.006 0 0 0-6.95 0l-1.72 1.71"/><path d="m5.17 11.75-1.71 1.71a5.004 5.004 0 0 0 .12 7.07 5.006 5.006 0 0 0 6.95 0l1.71-1.71"/><path d="M8 2v3"/><path d="M2 8h3"/><path d="M16 19v3"/><path d="M19 16h3"/>',
...
export function icon(name: IconName, size = 16, cls = "icon"): SVGSVGElement {
  ...
  svg.setAttribute("stroke-width", size <= 16 ? "1.75" : "1.5");
...
/** ALT mark: an orbit with a moving point — "working in the background". */
export function altMark(size = 20): SVGSVGElement {
  const svg = document.createElementNS("http://www.w3.org/2000/svg", "svg");
  svg.setAttribute("viewBox", "0 0 24 24");
  svg.setAttribute("width", String(size));
  svg.setAttribute("height", String(size));
  svg.setAttribute("aria-hidden", "true");
  svg.setAttribute("focusable", "false");
  svg.setAttribute("class", "alt-mark");
  svg.innerHTML =
    '<rect x="1" y="1" width="22" height="22" rx="6.5" fill="currentColor"/>' +
    '<circle cx="12" cy="12" r="5.25" fill="none" stroke="var(--background)" stroke-width="1.75"/>' +
    '<circle cx="16.1" cy="8.3" r="1.9" fill="var(--background)"/>';
  return svg;
}
